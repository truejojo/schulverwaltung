...
if (is_file(APP_DIR . '/inc/config.local.php')) {
    require_once APP_DIR . '/inc/config.local.php';
}
...
require_once APP_DIR . '/class/providers/data.school.class.php';
require_once APP_DIR . '/class/providers/dataprovider.school.class.php';
require_once APP_DIR . '/class/providers/mysqldataprovider.school.class.php';
