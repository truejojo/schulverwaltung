<div
  ...
  <h1 class="text-gray-600 dark:text-gray-300 text-4xl lg:text-5xl text-center">
    <?= htmlspecialchars($title ?? 'Login') ?>
  </h1>

  <div
    class="p-6 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm w-full max-w-md mx-auto">
    <form action="login.php" method="POST" class="space-y-5">
      <div>
        ...
        <input class="w-full p-2.5 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900
                 ...
                 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:border-orange-400" type="text"
      ...
      <div>
        ...
        <input class="w-full p-2.5 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900
                 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500
                 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:border-orange-400" type="password"
      ...
      <div class="pt-2">
        <button type="submit" class="w-full py-2.5 px-4 rounded-md border-2 border-orange-400/60
         ...
         focus:outline-none focus:ring-orange-400 focus:ring-offset-2 dark:focus:ring-offset-gray-900
